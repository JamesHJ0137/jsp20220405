...
<li>response : HttpServletRespnse</li>
<li>pageContext : PageContext</li>
<li>session : HttpSession</li>
<li>application : ServeletContext</li>
<li>out : JspWriter</li>
...
<h1>Attribute를 저장하거나 꺼낼 수 있는 객체 4가지</h1>
...
<li>application : ServeletContext (가장 넓은 영역 : 어플리케이션 내에서 모두 사용 가능)</li>
